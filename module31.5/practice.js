...
//উত্তরঃ জানি আলহামদুলিল্লাহ্‌। Notes এ লেখা আছে।
...
console.log (`
${user.name} work in ${user.company.name}.
His email address is: ${user.email}
He is Living in: ${user.address.city} city.
His Phone Number: ${user.phone}
...
//উত্তরঃ পড়ে পড়বো ইনশাল্লাহ। Notes এ লেখা আছে।
...
/* 
const result = [2,5,3,6,7].map (x => x*5)
console.log (result);
 */
...
/* 
const oddNumber = [1, 2, 4, 6, 3, 7, 1, 5, 7, 4, 9].filter(x => x % 2 !== 0)
...
const cellPhone = [
    ...
    { name: 'redmi', price: 200 },
]

const findTheKhoj = cellPhone.find(x => x.price === 5000)
console.log(findTheKhoj)
*/

// =======================================================

/* ৭.৫ [এক্সট্রা] জাভাস্ক্রিপ্ট এ array এর map, forEach, filter, find কোনটা দিয়ে কি হয়। সেটার একটা সামারি লিখে ফেলো।  */
//উত্তরঃ Notes এ লেখা আছে।
...
/* 
const array = ['zakir', 'rakib', 'emon', 'zadid'];
const [,,three] = array
console.log (three);
 */
...
/* 
const sum = (num1, num2, num3 = 10) => num1 + num2 + num3;
...
/* const nested = {
    mobile : {
        ...
        xiaomi: {
            ...
            price: [
                2000, 5000, 1000,
                {bendor: 'mi', origin: 'china'}
            ]
        }

    }
} */
// console.log (nested.mobile.xiaomi.price[3].origin)

/* ১২. উপরের অবজেক্ট এ ডট এর আগে যে প্রশ্নবোধক চিহ্ন দিয়ে যে অপশনাল চেইনিং করা যায়। সেটা একটু প্রাকটিস করো।  */

// console.log (nested.mobile.xiaomi?.price[3].origina)
